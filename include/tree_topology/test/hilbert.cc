...
template<
  ...
  size_t D>
bool
operator==(const point__<T,D>& a, const point__<T,D>&b)
{
...
TEST(hilbert_2d, coordinates) {
  ...
  {
    point__<double,2> pt(
      (double)rand()/(double)RAND_MAX*(range_2d[1][0]-range_2d[0][0])+range_2d[0][0],
      (double)rand()/(double)RAND_MAX*(range_2d[1][1]-range_2d[0][1])+range_2d[0][1]);
...
TEST(hilbert_3d, range_branch) {
  ...
  {
    point__<double,3> pt(
      (double)rand()/(double)RAND_MAX*(range_3d[1][0]-range_3d[0][0])+range_3d[0][0],
      (double)rand()/(double)RAND_MAX*(range_3d[1][1]-range_3d[0][1])+range_3d[0][1],
      (double)rand()/(double)RAND_MAX*(range_3d[1][2]-range_3d[0][2])+range_3d[0][2]);
