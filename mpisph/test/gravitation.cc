...
TEST(tree_colorer, mpi_qsort) {
  ...
  double jacobi_res[9] = {
      0., 1. / (3 * sqrt(3)), 1. / (3 * sqrt(3)), 1. / (3 * sqrt(3)),
      0., 1. / (3 * sqrt(3)), 1. / (3 * sqrt(3)), 1. / (3 * sqrt(3)),
      0.};
  double hessian_res[27] = {-0.2566, 0.1283,  0.1283,  0.1283,  0.1283,
                            0.32075, 0.1283,  0.32075, 0.1283,

                            0.1283,  0.1283,  0.32075, 0.1283,  -0.2566,
                            0.1283,  0.32075, 0.1283,  0.1283,

                            0.1283,  0.32075, 0.1283,  0.32075, 0.1283,
                            0.1283,  0.1283,  0.1283,  -0.2566};

  tfmm.computeAcceleration(sinkPosition, sourcePosition, sourceMass, fc, jacobi,
                           hessian);
  ...
  point_t fc_res_2 =
      point_t(-1. / (3 * sqrt(3)), -1. / (3 * sqrt(3)), -1. / (3 * sqrt(3)));
  ...
  double hessian_res_2[27] = {0.2566,   -0.1283,  -0.1283,  -0.1283,  -0.1283,
                              -0.32075, -0.1283,  -0.32075, -0.1283,
  ...
  double jacobi_res_3[9] = {0.,      3.00703, 3.00703, 3.00703, 0.,
                            3.00703, 3.00703, 3.00703, 0.};

  double hessian_res_3[27] = {10.0234,  -5.01172, -5.01172, -5.01172, -5.01172,
                              -12.5293, -5.01172, -12.5293, -5.01172,

                              -5.01172, -5.01172, -12.5293, -5.01172, 10.0234,
                              -5.01172, -12.5293, -5.01172, -5.01172,

                              -5.01172, -12.5293, -5.01172, -12.5293, -5.01172,
                              -5.01172, -5.01172, -5.01172, 10.0234};
