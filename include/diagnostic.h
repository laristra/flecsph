 ...
 */
void
compute_smoothinglength_stats(std::vector<body> & bodies,
 ...
 */
void
compute_velocity_stats(std::vector<body> & bodies, int64_t totalnbodies) {
...
output(body_system<double, gdimension> & bs, const int rank) {
  ...
  if(first_time) {
    ...
    oss_header << "# Diagnostic: " << std::endl
  ...
  oss_data << std::setw(5) << physics::iteration << std::setw(20)
           << std::scientific << std::setprecision(12) << physics::totaltime
           << std::setw(20) << h_min << std::setw(20) << h_max << std::setw(20)
           << h_average << std::setw(5) << N_min << std::setw(5) << N_max
           << std::setw(5) << N_average << std::setw(20) << min_dist
           << std::setw(20) << average_dist_in_h << std::setw(20) << V_min
           << std::setw(20) << V_max << std::setw(20) << V_average
