...
def create_output(dataset):
    ...
    # Create table
    head = 'column1:x, column2:y, column3:z, column4:r, column5:rho, column6:P, column7:u, column8:vx'
    data = np.column_stack((x_data, y_data, z_data, rad_distance, rho_data, P_data, u_data, vx_data))
